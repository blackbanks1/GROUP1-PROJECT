        ...
        <div className="lg:col-span-8">
           <Card className="bg-white border-none shadow-xl rounded-[3rem] p-12 space-y-12 relative overflow-hidden">
              ...
              <div className="flex justify-end gap-4 pt-12">
                 <Button variant="ghost" className="h-16 px-10 rounded-2xl text-slate-400 hover:text-slate-900 hover:bg-slate-50 font-black uppercase tracking-widest text-[10px] mb-1">
                    Reset Defaults
                 </Button>
                 <Button className="bg-primary-600 hover:bg-primary-700 h-16 px-12 rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-primary-600/10 border-none transition-all hover:scale-105 text-white mb-1">
                    Synchronize Changes
                 </Button>
              </div>
           </Card>
...
function PreferenceSwitch({ label, description, defaultChecked = false }: { label: string; description: string; defaultChecked?: boolean }) {
  return (
