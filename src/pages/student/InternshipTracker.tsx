          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-12">
               <div className="space-y-1">
                  ...
                  <p className="text-primary-600 text-xs font-bold uppercase tracking-widest">Phase 02: Backend Integration</p>
               </div>
...
function TimelineItem({ title, date, status }: { title: string; date: string; status: string }) {
  return (
...
function SupervisorCard({ name, role, feedback }: { name: string; role: string; feedback: string }) {
  return (
