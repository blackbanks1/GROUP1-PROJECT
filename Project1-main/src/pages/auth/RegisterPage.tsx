...
type Step = 'role' | 'info' | 'setup' | 'complete';
type Role = 'student' | 'company' | 'lecturer' | 'admin';
    ...
    <div className="min-h-screen bg-white text-slate-950 flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
            ...
            <h1 className="text-3xl font-bold tracking-tight font-display uppercase italic text-slate-900">
          ...
          <AnimatePresence mode="wait">
            {step === 'role' && (
              <motion.div key="role" variants={containerVariants} initial="initial" animate="animate" exit="exit">
                    ...
                    {roles.map((role) => (
                        ...
                        >
                            ...
                            <div className="space-y-2">
                                <h3 className="text-xl font-bold italic font-display uppercase tracking-tight text-slate-900">{role.label}</h3>
                ...
                <div className="mt-12 flex justify-center">
                   <Button onClick={handleNextStep} size="lg" className="h-16 px-12 text-xs font-black uppercase tracking-[0.2em] bg-primary-600 hover:bg-primary-700 text-white rounded-full group shadow-xl shadow-primary-600/20 border-none">
                      Continue
                ...
                <Card className="bg-white border-slate-100 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-200/50 border-none">
                   <CardContent className="p-8 space-y-6">
                      <div className="grid gap-6">
                         ...
                         <div className="space-y-2">
                           <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Work Email</Label>
                         ...
                         <div className="space-y-2">
                           <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Password</Label>
                      ...
                      <div className="pt-4 space-y-4">
                        <Button onClick={handleNextStep} className="w-full h-14 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary-600/10 border-none">
                            Next Step
                        </Button>
                        <Button variant="ghost" onClick={handlePrevStep} className="w-full text-slate-400 hover:text-slate-950 hover:bg-slate-50 rounded-xl h-14 font-black text-[10px] uppercase tracking-widest">
                            Go Back
                        </Button>
                      </div>
                   </CardContent>
                   ...
                   <CardContent className="p-8 space-y-8">
                      {selectedRole === 'student' && (
                        <div className="space-y-6">
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">University</Label>
                           ...
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Major / Department</Label>
                           ...
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Resume / CV</Label>
                             <div className="border-2 border-dashed border-slate-100 rounded-2xl p-8 flex flex-col items-center justify-center gap-2 hover:border-primary-400 hover:bg-primary-50 transition-all cursor-pointer group bg-slate-50/50">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-widest text-slate-300 group-hover:text-slate-600">Click to upload or drag & drop</p>
                             </div>
                           </div>
                        </div>
                      )}
                      ...
                      {selectedRole === 'company' && (
                        <div className="space-y-6">
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Company Name</Label>
                           ...
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Industry</Label>
                           ...
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Company Website</Label>
                      ...
                      {(selectedRole === 'lecturer' || selectedRole === 'admin') && (
                        <div className="space-y-6">
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Faculty / Department</Label>
                           ...
                           <div className="space-y-2">
                             <Label className="text-[10px] uppercase font-black tracking-widest text-slate-400 px-1">Specialization</Label>
                      ...
                      <div className="pt-4 space-y-4">
                        <Button 
                          ...
                          disabled={isLoading}
                          className="w-full h-14 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary-600/10 border-none relative overflow-hidden"
                        >
                           {isLoading ? (
            ...
            {step === 'complete' && (
              <motion.div key="complete" variants={containerVariants} initial="initial" animate="animate" className="text-center space-y-12">
                 ...
                 <div className="space-y-6">
                    <h2 className="text-5xl font-bold tracking-tighter text-slate-900 font-display uppercase italic">Registration Successful</h2>
                    <p className="text-slate-500 text-xl max-w-lg mx-auto font-medium">
                 ...
                 <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <Button 
                      ...
                      size="lg" 
                      className="h-16 px-12 text-xs font-black uppercase tracking-[0.2em] bg-primary-600 text-white hover:bg-primary-700 rounded-full shadow-xl shadow-primary-600/20 border-none"
                    >
                       Go to Login
                    </Button>
                    <Link to="/">
                       <Button variant="ghost" size="lg" className="h-16 px-12 text-xs font-black uppercase tracking-[0.2em] text-slate-400 hover:text-slate-900 hover:bg-slate-50 rounded-full">
                          Return Home
                       </Button>
                    </Link>
                 </div>
